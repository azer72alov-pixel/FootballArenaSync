export const TRANSLATIONS = {
  az: {
    ...
    shareApp: "Telegram Tətbiqi",
    androidApp: "Android Tətbiqi",
    downloadApk: "APK-nı Yüklə",
  ...
  ru: {
    ...
    shareApp: "Telegram Приложение",
    androidApp: "Android Приложение",
    downloadApk: "Скачать APK файл",
