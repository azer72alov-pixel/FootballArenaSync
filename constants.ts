...
// Приложение само подставит текущий домен сайта.
// Файл должен лежать в папке: public/android/ArenaSync.apk
// =================================================================
export const ANDROID_APP_LINK = '/android/ArenaSync.apk'; 
